...
export default function MapBox({
  ...
  useEffect(() => {
    ...
    if (
      viewport.latitude !== userGeolocation.location.lat ||
      viewport.longitude !== userGeolocation.location.lng
    )
      setViewport({
        ...viewport,
        latitude: userGeolocation.location.lat,
        longitude: userGeolocation.location.lng,
      });
  }, [userGeolocation]);
          ...
          <button
            ...
            onClick={() => {
              ...
              return myMap.current
                ...
                .flyTo({
                  center: [
                    userGeolocation.location.lng,
                    userGeolocation.location.lat,
                  ],
                });
            }}
          >
